...
document.querySelector('.form').addEventListener('submit', function (event) {
  ...
  var delay = parseInt(document.querySelector('input[name="delay"]').value, 10);
  var step = parseInt(document.querySelector('input[name="step"]').value, 10);
  var amount = parseInt(document.querySelector('input[name="amount"]').value, 10);
  for (var i = 1; i <= amount; i++) {
    createPromise(i, delay + (i - 1) * step).then(function (_ref) {
...
//# sourceMappingURL=/goit-js-hw-09/03-promises.b10f5643.js.map